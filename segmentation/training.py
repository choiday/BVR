...
from keras.layers import Input, Conv2D, merge, MaxPooling2D, UpSampling2D, Reshape, core, Dropout
...
patches_imgs_train, patches_masks_train = get_data_training(
    IMGC_train_imgs_original = path_data + config.get('data paths', 'train_imgs_original'),
    IMGC_train_groudTruth = path_data + config.get('data paths', 'train_groundTruth'),  #masks
